document.addEventListener('DOMContentLoaded', () => {
    ...
    const products = [
        ...
        },
        {
            ...
            function displayProducts(products, container, isFeatured = false) {
                products.forEach(product => {
                    const productElement = document.createElement('div');
                    productElement.className = isFeatured ? 'featured-product' : 'product';
            ...
            const featuredProducts = products.slice(0, 2); // Just an example to feature first 2 products
            ...
            if (featuredProductsContainer) {
                ...
                displayProducts(featuredProducts, featuredProductsContainer, true);
            } else {
            ...
            if (productNameSelect) {
                console.log("Product name select found");
                products.forEach(product => {
                ...
                console.log("Product name select not found");
            }
